...
/** \brief Valida que la cadena que recibe la funcion no contenga caracteres no numericos dentro
...
/** \brief Pone mayuscula en la primera letra de la/s palabra/s y minuscula en el resto
* \param char* str: la cadena a validar
* \return -1 en caso de error, 0 en caso de exito
*/
